...
describe('<FullHeader />', () => {
    ...
    context('bgImg', () => {
        it('should have empty background-image when none is passed', () => {
            const wrapper = shallow(<FullHeader />);
            expect(wrapper.find('background-image')).to.have.length(0);
        });

        it('should have background-image named bg.jpg when passed', () => {
